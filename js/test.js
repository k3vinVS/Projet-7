...
// console.log(recipes[0].name.includes('Coco'));
...
function recherchePrincipale(listOfRecipes, itemToSearch) {
  let result = listOfRecipes.filter(
    (recipe) =>
      ...
      recipe.description.toLowerCase().includes(searchItem.toLowerCase()) ||
      recipe.appliance.toLowerCase().includes(searchItem.toLowerCase()) ||
      recipe.ustensils
        .join()
        .toLowerCase()
